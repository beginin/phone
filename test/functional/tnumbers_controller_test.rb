...
class TnumbersControllerTest < ActionController::TestCase
  ...
  test "should create tnumber" do
    assert_difference('Tnumber.count') do
      post :create, :tnumber => { :block => @tnumber.block, :sortnumber => @tnumber.sortnumber, :voicenumber => @tnumber.voicenumber }
    end
  ...
  test "should update tnumber" do
    put :update, :id => @tnumber, :tnumber => { :block => @tnumber.block, :sortnumber => @tnumber.sortnumber, :voicenumber => @tnumber.voicenumber }
    assert_redirected_to tnumber_path(assigns(:tnumber))
  end
