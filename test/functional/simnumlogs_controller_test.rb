...
class SimnumlogsControllerTest < ActionController::TestCase
  ...
  test "should create simnumlog" do
    assert_difference('Simnumlog.count') do
      post :create, :simnumlog => { :sim_id => @simnumlog.sim_id, :simperiod_id => @simnumlog.simperiod_id, :tnumber_id => @simnumlog.tnumber_id }
    end
  ...
  test "should update simnumlog" do
    put :update, :id => @simnumlog, :simnumlog => { :sim_id => @simnumlog.sim_id, :simperiod_id => @simnumlog.simperiod_id, :tnumber_id => @simnumlog.tnumber_id }
    assert_redirected_to simnumlog_path(assigns(:simnumlog))
  end
