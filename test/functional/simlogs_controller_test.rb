...
class SimlogsControllerTest < ActionController::TestCase
  ...
  test "should create simlog" do
    assert_difference('Simlog.count') do
      post :create, simlog: { pda: @simlog.pda, period_id: @simlog.period_id, sim_id: @simlog.sim_id, user_id: @simlog.user_id }
    end
  ...
  test "should update simlog" do
    put :update, id: @simlog, simlog: { pda: @simlog.pda, period_id: @simlog.period_id, sim_id: @simlog.sim_id, user_id: @simlog.user_id }
    assert_redirected_to simlog_path(assigns(:simlog))
  end
